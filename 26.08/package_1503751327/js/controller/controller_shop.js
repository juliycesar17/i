...
$("body" ).on( "click", '#ind', function(e) {
 ...
 var items=ui ;
  if(window.location!='http://www.joyforchild.com/ice' && window.location!='http://joyforchild.com/ice' ){
...
if(window.location!='http://www.joyforchild.com/ice/your-ice' && window.location!='http://joyforchild.com/ice/your-ice'){
  ...
  else {history.pushState('http://www.joyforchild.com/ice/get_flexi_one.php?q='+$(this).attr('data-idd'), document.title, 'http://joyforchild.com/ice/your-ice');}
