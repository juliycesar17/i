...
<div class="w3-row-padding aaa">
 ...
 <a  >
      ...
      <div class="w3-container w3-white">
        <p><b>{{enterprise}}</b></p>
		<button class="add"  data-id="{{id}}" data-idd="{{id}}" data-param='get_flexi_one.php' data-price='{{price}}' data-name='{{ice_cream}}' data-brend='{{enterprise}}' data-image='{{image}}' class="w3-btn w3-black w3-padding-large w3-hover-red add">{{add}}</button>
