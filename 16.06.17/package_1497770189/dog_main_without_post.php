...
<div class="w3-main" style="margin-left:300px">
 ...
 while( $row44=mysqli_fetch_array($result44) ) {?>
   <?php if ($item_num >0 and $item_num % 3 == 0) { ?>
                 ...
                 <div class="w3-third w3-container w3-margin-bottom">
                     <a  class="dog_flexi" data-function='flexi' data-param='flexi.php' data-url='flexi'  data-vid='<?php echo $row44['vse_vidi_tov'] ?>' href='flexi.php?vid=<?php echo $row44['vse_vidi_tov'] ?>'>
                   <img src=<?php echo $row44['image'] ?> alt="Norway" style="width:100%" class="w3-hover-opacity">
	                     </a>
                         <div class="w3-container w3-white">
                         <p><b><?php echo $row44['vse_vidi_tov'] ; ?></b></p>
		                  <ul class="w3-ul">
						   <?php list($aa,$bb,$cc,$dd)=split('[/.,]', $row44['brends']); ?>
							<li><h7><a href='' > <?php echo $aa ;?></li></h7></a>
							<li><h7><a href='' ><?php echo $bb ;?></li></h7></a>
							<li><h7><a href='' ><?php echo $cc; ?></li></h7></a>
		                </ul>
                          </div>
                          </div>
  <?php $item_num++; } ?>
...
<script src="js/hist1.js" defer></script>
<!--<script src="js/ind.js"></script>-->
<script src="js/for_images.js" defer></script>
<script src="js/handlebars-v4.0.5.js"></script>
<!--<script src="js/ind.js"></script>-->
<script src="js/brends.js" defer></script>
<!--<script src="js/helper_for_addtocart.js"></script>-->
<script src="js/event.js" defer></script>
<script src="js/model/modelclass.js" defer></script>
<script src="js/view/viewclass.js" defer></script>
<script src="js/view/view_shop.js" defer></script>
<script src="js/view/view_cart.js" defer></script>
<script src="js/view/view_login.js" defer></script>
<script src="js/controller/controllerclass.js" defer></script>
<script src="js/for_ajax.js" defer></script>
<script src="js/check.js" defer></script>
<script src="js/model/model_shop.js" defer></script>
<script src="js/model/model_cart.js" defer></script>
<script src="js/model/model_login.js" defer></script>
<script src="js/accesstomodel.js" defer></script>
<script src="js/controller/controller_cart.js" defer></script>
<script src="js/controller/controller_login.js" defer></script>
<script src="js/controller/controller_shop.js" defer></script>

<script src="js/app.js" defer></script>
<!--<script src="js/start.js"></script>-->
<script src="js/help.js" defer></script>
<script src="js/for_if_helper.js" defer></script>
<script src="js/helper_for_one.js" defer></script>
<script src="js/row.js" defer></script>
<!--<script src="js/onpopstate.js"></script>-->
<script src="js/ajax.js" defer></script>
<script src="js/yellow.js" defer></script>
</body>
</html>
