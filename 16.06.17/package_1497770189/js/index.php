...
<div class="w3-main" style="margin-left:300px">
 <header class="w3-container">
	...
	<button class="w3-btn w3-white"><i class="fa fa-user"></i><a id='login'>вход</a></button>
	<button  class="w3-btn w3-white "><i class="glyphicon glyphicon-shopping-cart"></i><a data-param='cart.php' data-cart='ii' id='cart'> корзина</a></button>
