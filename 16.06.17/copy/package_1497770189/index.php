...
<div class="w3-row-padding aaa">
	{{#each this}}
 <div class="w3-third w3-container w3-margin-bottom">
 <a  data-v="{{../../ppp.sess_vid}}" class="flexi-tov" href="flexi-tovari.php?q={{brend}}&vvv={{../../ppp.sess_vid}}" data-param="flexi-tovari.php" data-brend='{{brend}}'  data-ses={{../../ppp.sess_vid}}>
