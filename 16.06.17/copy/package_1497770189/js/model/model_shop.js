...
arguments[1].itemAddCart.attachd(function () {
  console.log(arguments);
   ...
   var title=arguments[1].not[4];
	 ...
	 _this._itttems['get_flexi_one.php-'+argus].added='true';
	 return _this.ajax({url:'get_flexi_one.php', id:argus}).then(function(msg){
	   return _this.addItem(msg, 'get_flexi_one.php',title)});	;
  });
  //===================
