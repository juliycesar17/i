...
function ListViewshop() {
 ...
 /* arguments[0].logintempl.attachd(function () {
  ...
  _this.browseshop.notify({url:'dog_main.php','title':'browsershop'});
   break;
  ...
  _this.browseshop.notify({url:'flexi.php',  flex:param_for_flexi_vid});
   break;
   case 'http://www.joyforchild.com/ice/flexi-tovari.php?q='+brend_brend+'&vvv='+ses_ses_ses:
  _this.browseshop.notify({url:'flexi-tovari.php', brend:brend_brend, vidd:ses_ses_ses,'title':'browse_items'});
   break;
   case 'http://www.joyforchild.com/ice/get_flexi_one.php?q='+id_one_one_one:
  _this.browseshop.notify({url:'get_flexi_one.php', id:id_one_one_one});
   break;
   }
 }	
}
