...
$query44="select  enterprise.brend, enterprise.image from enterprise left join enterpr_ice_cr on enterprise.brend=enterpr_ice_cr.brend where enterpr_ice_cr.vse_vidi_tov='".$_GET['vid']."' limit 8 ";
...
<body id='tyty' class="w3-light-grey w3-content" style="max-width:1600px">
...
<div class="w3-main" style="margin-left:300px">
 ...
 while( $row44=mysqli_fetch_array($result44) ) {?>
   <?php if ($item_num >0 and $item_num % 3 == 0) { ?>
                 ...
                 <div class="w3-third w3-container w3-margin-bottom">
 <a data-v="<?php echo $_SESSION['vid']; ?>" class="flexi-tov" href="flexi-tovari.php?q=<?php echo $row44['brend']?>&vvv=<?php echo $_SESSION['vid']; ?>" data-param="flexi-tovari.php" data-brend=<?php echo $row44['brend']?>  data-ses=<?php echo $_SESSION['vid'];?>>
      <img src="image/brends/<?php echo $row44['image']?>" alt="<?php echo $row44['image']?>" style="width:100%" class="w3-hover-opacity">
	  </a>
      <div class="w3-container w3-white iiiiiiiiiiiiiii">
        <p><b><?php echo $row44['brend'].' without';?></b></p>
...
<script src="js/prover_for_flexi.js"></script>
