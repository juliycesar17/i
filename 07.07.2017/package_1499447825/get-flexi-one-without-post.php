...
$query="select *  from items where id='".$_GET['q']."'";
...
<div class="w3-row-padding aaa">
	{{#each this}}
 <div class="w3-third w3-container w3-margin-bottom">
 <a  data-v="{{../../ppp.0.sess_vid}}" class="flexi-tov" href="flexi-tovari.php?q={{brend}}&vvv={{../../ppp.0.sess_vid}}" data-param="flexi-tovari.php?q={{brend}}&vvv={{../../ppp.0.sess_vid}}" data-brend='{{brend}}'  data-ses={{../../ppp.0.sess_vid}}>
...
<div class="w3-row-padding aaa">
	{{#each this}}
 <div class="w3-third w3-container w3-margin-bottom">
 <a  href="get_flexi_one.php?q={{id}}" data-param="get_flexi_one.php?q={{id}}" data-idd="{{id}}" class="flex_f_one">
...
<div class="w3-main" style="margin-left:300px">
 ...
 <a>
      ...
      <div class="w3-container w3-white">
		...
		<button class="add"  data-param='add_tocart_n.php' data-id=<?php echo $row44['id'];?> data-price=<?php echo $row44['price'];?> 
...
<script src="js/prover_for_flexi_one.js"></script>
