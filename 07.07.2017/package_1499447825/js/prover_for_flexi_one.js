...
function ListView(model, elements) {
	...
	console.log(event.state);
		...
		console.log(newval2);
		//-------------------------
		var valll= newval.split("=");
		var vannn= newval2.split("=");
		//--------------------------
		var val_arr=valll[1];
		var val_arrr_s=vannn[1];
		
		//-------------------------
		if (typeof arrr!=='undefined') {arrr=arrr } else { arrr= val_arr;}
		if (typeof arrrv!=='undefined') {arrrv=arrrv } else { arrrv= val_arrr_s;}
		
		//if (typeof arf!=='undefined') {arf=arf } else { arf= 'http://www.joyforchild.com/ice/flexi-tovari.php?q='+arrr+'&vvv='+arrrv;}
		console.log(arf);
		console.log(arrr);
		console.log(arrrv);
  ...
  _this.addButtonClicked.notify({url:'flexi.php'});
   break;
    case 'http://www.joyforchild.com/ice/flexi-tovari.php?q='+arrr+'&vvv='+arrr_s:
	 //case 'http://www.joyforchild.com/ice/oooooooo':
...
$(function () {
    var model = new ListModel('{ "employees" : "jjj"}');
		...
		history.pushState('http://www.joyforchild.com/ice/flexi-tovari.php'+window.location.search, document.title, 'http://www.joyforchild.com/ice/flexi-tovari.php'+window.location.search);
